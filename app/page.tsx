          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground/80 mb-12 leading-relaxed">
                A powerful, intuitive GUI for PostgreSQL that brings the
                elegance of MongoDB Compass to the world of relational
                databases. Manage your data with confidence.
              </p>
